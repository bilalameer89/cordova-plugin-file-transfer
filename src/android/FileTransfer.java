...
//          conn.setHostnameVerifier(hostnameVerifier);
          ...
          if (headers != null) {
            ...
            if(headers.get("cookies")!=null) {
              conn.setRequestProperty("Cookie", headers.get("cookies").toString());
            }
          }
        ...
        try {
          ...
          if (isLocalTransfer) {
            ...
            if (headers != null) {
              ...
              if(headers.get("cookies")!=null) {
                connection.setRequestProperty("Cookie", headers.get("cookies").toString());
              }
            }
